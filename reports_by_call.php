...
<li class="nav-item dropdown ">
       ...
       <center>
        ...
        <input type="submit" name="sort1" value="Reports by call" class="btn btn-dark sort-btn">
            ...
            <form name="repbykm" action="reports_by_km.php" method="POST">
        <input type="submit" name="sort2" value="Reports by KM" class="btn btn-dark sort-btn">
           </form>
          
            <form name="highscores" action="highscores.php" method="POST">
        <input type="submit" name="sort3" value="Highscores" class="btn btn-dark sort-btn">
           </form>
       </div>
        </center>
        ...
        <div id="container">
          <center>
            <?php
              ...
              $select = "SELECT call_sign,name,date,time,rst,locator,freqmhz,mode,remark FROM nadajnik ORDER BY call_sign DESC";
