...
<li class="nav-item dropdown ">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="../pl/archiwumpl.php"><img src="../gfx/pl.png" alt="Polish" class="fl"></a>
          ...
          <a class="dropdown-item" href="archiwumru.php"><img src="../gfx/rus.png" alt="Russian" class="fl"></a>
        </div>
      </li>
                    </ul>
                </div>
